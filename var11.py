...
class Bank:
    ...
    def oper(self): #разделение датафрейма на 2 разных
        ...
        self.df1 = self.df[self.df['Время оплаты'] <= '23:00:00']    # строки, удовлетворяющие условию
        self.df1.to_csv('first.csv')
        self.df2 = self.df[self.df['Время оплаты'] <= '09:00:00']    # строки, не удовлетворяющие условию
        self.df2 = self.df[self.df['Время оплаты'] >= '23:00:00']    # строки, не удовлетворяющие условию
